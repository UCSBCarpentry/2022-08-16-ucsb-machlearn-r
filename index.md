...
humantime: "9:30 am - 1:00 pm PST"    # human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
...
instructor: ["Dave Hunter", "Greg Janée"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Seth Erickson", "Amanda Ho", "Kristi Liu"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
{% else %}
<p><a href="https://ucsb.co1.qualtrics.com/jfe/form/SV_1ZgWPiOst63DJ42">Pre-workshop Survey</a></p>
<p><a href="https://ucsb.co1.qualtrics.com/jfe/form/SV_brvYXIDO8qanXvg">Post-workshop Survey</a></p>
{% endif %}
...
<p>
  ...
  {% endif %}
  workshop,
  you will need access to software as described on this page: <a href= "https://carpentries-incubator.github.io/r-ml-tabular-data/setup.html"><strong>Setup Page</strong></a>.
